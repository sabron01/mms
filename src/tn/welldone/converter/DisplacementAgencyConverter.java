...
@FacesConverter("displacementAgencyConverter")
public class DisplacementAgencyConverter implements Converter {
	...
	public Object getAsObject(FacesContext context, UIComponent component,
		...
		for (ServiceProvider agency : data.getAmbulancesAgencies()) {
